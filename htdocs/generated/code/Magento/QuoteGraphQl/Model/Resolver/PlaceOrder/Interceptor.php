...
class Interceptor extends \Magento\QuoteGraphQl\Model\Resolver\PlaceOrder implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\QuoteGraphQl\Model\Cart\GetCartForUser $getCartForUser, \Magento\Quote\Api\CartManagementInterface $cartManagement, \Magento\Sales\Api\OrderRepositoryInterface $orderRepository, \Magento\QuoteGraphQl\Model\Cart\CheckCartCheckoutAllowance $checkCartCheckoutAllowance, \Magento\Quote\Api\PaymentMethodManagementInterface $paymentMethodManagement)
    {
        $this->___init();
        parent::__construct($getCartForUser, $cartManagement, $orderRepository, $checkCartCheckoutAllowance, $paymentMethodManagement);
    }
